...
export default async function RegisterContributionPage() {
  try {
    await requirePermission('aportes:create');
  } catch {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900">Registrar Aporte</h1>
        <p className="text-gray-600">
          Registra un nuevo aporte real de un residente
        </p>
      </div>
      ...
      <div className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-8">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Permiso requerido: <code className="rounded bg-gray-200 px-1">aportes:create</code>
          </p>
          <p className="mt-1 text-sm text-gray-500">
          ...
          <div className="mt-4 text-left text-xs text-gray-400">
            ...
            <ul className="mt-2 list-inside list-disc space-y-1">
              ...
              <li>Medio de pago (efectivo, transferencia, etc.)</li>
              <li>Comprobante (adjunto opcional)</li>
              <li>Notas</li>
            </ul>
          </div>
        </div>
