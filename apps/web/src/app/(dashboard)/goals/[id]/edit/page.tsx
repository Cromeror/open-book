...
export default async function EditGoalPage({ params }: EditGoalPageProps) {
  ...
  try {
    await requirePermission('goals:update');
  } catch {
    redirect(`/goals/${id}`);
  }
      ...
      <div className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-8">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Permiso requerido: <code className="rounded bg-gray-200 px-1">goals:update</code>
          </p>
          <p className="mt-1 text-sm text-gray-500">
          ...
          <div className="mt-4 text-left text-xs text-gray-400">
            ...
            <ul className="mt-2 list-inside list-disc space-y-1">
              ...
              <li>Descripcion</li>
              <li>Monto objetivo (si no tiene aportes)</li>
              <li>Fecha fin</li>
            </ul>
          </div>
        </div>
