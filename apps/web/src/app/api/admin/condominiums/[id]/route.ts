 ...
 * Get a specific condominium by ID (SuperAdmin only)
 */
export async function GET(_request: NextRequest, { params }: RouteParams) {
  ...
  try {
    const response = await fetch(`${API_BASE_URL}/admin/condominiums/${id}`, {
      headers: {
 ...
 * Update a specific condominium by ID (SuperAdmin only)
 */
 ...
 * Delete a specific condominium by ID (SuperAdmin only)
 */
