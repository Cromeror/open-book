export { CapudataRoleDetail } from './CapudataRoleDetail';
export type { CapudataRoleDetailProps, CapudataRoleMemberInfo, CapudataResourceAccessInfo } from './CapudataRoleDetail';
