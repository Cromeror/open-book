  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow">
          <p className="text-sm text-gray-500">Accesos a Recursos</p>
          <p className="text-2xl font-semibold text-gray-900">{resourceAccess.length}</p>
        </div>
        <div className="rounded-lg border border-gray-200 bg-white p-4 shadow">
          <p className="text-sm text-gray-500">Creado</p>
          <p className="text-lg font-medium text-gray-900">
            {new Date(role.createdAt).toLocaleDateString('es-CO')}
          </p>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow">
        <div className="flex items-center justify-between border-b border-gray-200 p-4">
          <div>
            <h3 className="text-base font-semibold text-gray-900">Miembros del Rol</h3>
            <p className="text-sm text-gray-500">Usuarios que pertenecen a este rol</p>
          </div>
          <button
            type="button"
      ...
      <div className="rounded-lg border border-gray-200 bg-white shadow">
        <div className="flex items-center justify-between border-b border-gray-200 p-4">
          <div>
            <h3 className="text-base font-semibold text-gray-900">Acceso a Recursos</h3>
            <p className="text-sm text-gray-500">Recursos externos a los que tienen acceso los miembros de este rol</p>
          </div>
          <button
            type="button"
