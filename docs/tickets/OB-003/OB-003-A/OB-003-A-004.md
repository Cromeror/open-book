...
### Archivos afectados
- `src/api/routes/towers.routes.ts`
- `src/api/controllers/towers.controller.ts`
- `src/services/tower.service.ts`
...
- [ ] CRUD de torres bajo /api/condominiums/:id/towers
...
Endpoints:
```
POST   /api/condominiums/:condoId/towers
GET    /api/condominiums/:condoId/towers
PATCH  /api/condominiums/:condoId/towers/:id
DELETE /api/condominiums/:condoId/towers/:id
```
