...
### Archivos afectados
- `src/domain/actividad-state-machine.ts`
...
Request:
```
PATCH /api/copropiedades/:copId/objetivos/:objId/actividades/:id/estado
Body: {
  "nuevoEstado": "FINALIZADA",
  "justificacion": "Rifa realizada exitosamente el 15/04"
}
```
