...
- [ ] Entidad User creada con decoradores TypeORM
- [ ] Campos de autenticacion: email (unico), passwordHash
- [ ] Campos de perfil: firstName, lastName, phone
- [ ] Campo rol: role (enum: ADMIN, RESIDENT)
- [ ] Campos de consentimiento: publicAccountConsent, consentDate
- [ ] Hereda campos de auditoria de BaseEntity
- [ ] Indices apropiados (email unico)
