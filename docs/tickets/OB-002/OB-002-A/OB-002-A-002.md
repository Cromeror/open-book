...
- [x] Endpoint POST /api/auth/register creado con @Post decorator
- [x] Acepta: email, password, firstName, lastName, phone, publicAccountConsent
- [x] Retorna 201 con datos del usuario (sin passwordHash)
- [x] Retorna 400 si faltan campos requeridos (ValidationPipe)
- [x] Retorna 409 si el email ya existe
- [x] El usuario queda registrado en la base de datos
...
- [x] Registro exitoso retorna 201
- [x] Email duplicado retorna 409
- [x] Campos faltantes retornan 400
- [x] El passwordHash no se incluye en la respuesta
