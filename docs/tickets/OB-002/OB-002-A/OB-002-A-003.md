...
- [x] Esquema de validacion creado con zod
- [x] Email debe ser formato valido
- [x] Contrasena minimo 8 caracteres, 1 mayuscula, 1 numero
- [x] firstName y lastName requeridos, minimo 2 caracteres
- [x] phone opcional pero con formato valido si se provee
- [x] Mensajes de error claros y en espanol
...
- [x] Email invalido retorna error descriptivo
- [x] Contrasena debil retorna error descriptivo
- [x] Campos vacios retornan errores apropiados
- [x] Datos validos pasan la validacion
