...
- [x] Endpoint POST /api/auth/login creado
- [x] Acepta email y password en el body
- [x] Retorna 200 con accessToken y refreshToken si es exitoso
- [x] Retorna 401 con mensaje generico si falla
- [x] Actualiza lastLoginAt del usuario
