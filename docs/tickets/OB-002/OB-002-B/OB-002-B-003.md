...
- [ ] JwtAuthGuard creado usando @nestjs/passport
- [ ] JwtStrategy configurada para validar tokens
- [ ] Decorador @CurrentUser() para obtener usuario en controllers
- [ ] Retorna 401 si no hay token
- [ ] Retorna 401 si token es invalido o expirado
- [ ] Pasa al siguiente handler si es valido
