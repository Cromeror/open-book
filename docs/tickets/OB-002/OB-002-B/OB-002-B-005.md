...
- [ ] Entidad AuthLog creada con TypeORM
- [ ] Login exitoso registra evento con IP y user agent
- [ ] Login fallido registra intento (email, IP, razon)
- [ ] Logout registra evento
- [ ] Los eventos son consultables por administradores
- [ ] No se registran contrasenas en ningun caso
