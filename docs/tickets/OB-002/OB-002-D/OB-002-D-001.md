...
- [x] Endpoint GET /api/auth/me creado (implementado en auth controller)
- [x] Requiere autenticacion (token valido)
- [x] Retorna todos los campos del perfil excepto passwordHash
- [x] Incluye informacion de consentimiento de visibilidad
- [x] Incluye fecha de ultimo login
