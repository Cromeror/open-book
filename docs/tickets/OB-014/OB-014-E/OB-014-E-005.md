...
|--------|------------|-------------|
| `reportes` | ReportsModule | Graficos, dashboards, exportacion |
| `auditoria` | AuditModule | Log de auditoria, filtros avanzados |
| `configuracion` | SettingsModule | Configuracion del sistema |
...
export function registerSpecializedModules(): void {
  moduleRegistry.register('reportes', ReportsModule);
  moduleRegistry.register('auditoria', AuditModule);
  moduleRegistry.register('configuracion', SettingsModule);
}
```
...
('reportes', 'Reportes', 'Visualiza reportes y estadisticas de la copropiedad', 'BarChart3', 'specialized',
 'ReportsModule',
...
('auditoria', 'Auditoria', 'Log de auditoria del sistema', 'FileText', 'specialized',
 'AuditModule',
...
('configuracion', 'Configuracion', 'Configuracion del sistema', 'Settings', 'specialized',
 'SettingsModule',
