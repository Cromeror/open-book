...
- [x] Middleware intercepta todas las rutas protegidas
- [x] Verifica existencia y validez del JWT en cookie
- [x] Redirige a /login si no hay token o es invalido
- [x] Rutas /admin/* requieren isSuperAdmin en JWT
- [x] Rutas publicas no requieren autenticacion
- [x] Preserva redirect URL en query param al ir a login
- [x] Funciona en Edge Runtime (delegando verificacion a backend)
