...
|--------|-------|---------|
| /users | requireModule | users |
| /users/[id] | requirePermission | users:read |
| /users/[id]/edit | requirePermission | users:update |
| /users/[id]/permissions | requireSuperAdmin | - |
| /users/[id]/privacy | requirePermission | users:manage |

### Perfil (Usuario)
| Pagina | Guard | Permiso |
|--------|-------|---------|
| /profile | requireAuth | - |
| /profile/edit | requireAuth | - |
| /profile/notifications | requireAuth | - |

**NOTA**: Las paginas de /profile solo requieren autenticacion, no permisos especiales. El usuario siempre puede ver y editar su propio perfil.
