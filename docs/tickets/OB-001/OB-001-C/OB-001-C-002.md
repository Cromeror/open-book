...
- [x] Base de datos de test configurada (openbook_test)
- [x] .env.test con DATABASE_URL de testing
- [x] Helper para limpiar base de datos entre tests
- [x] Sincronizacion automatica de esquema en tests
- [x] Tests no afectan base de datos de desarrollo
