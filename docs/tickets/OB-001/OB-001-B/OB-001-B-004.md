...
- [x] Directorio apps/api/src/migrations/ creado y versionado
- [x] Scripts pnpm: migration:generate, migration:run, migration:revert
- [x] Archivo typeorm.config.ts para CLI configurado
- [x] Primera migracion inicial creada
