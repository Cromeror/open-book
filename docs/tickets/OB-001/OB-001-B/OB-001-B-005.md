...
- [x] @DeleteDateColumn configurado en entidad base
- [x] softRemove() marca deletedAt automaticamente
- [x] Queries filtran automaticamente registros con deletedAt != null
- [x] Metodo withDeleted() para consultar registros eliminados (auditoria)
- [x] Campo deletedBy se llena con el usuario que elimina
- [x] Documentacion del comportamiento de soft delete
